                    ...
                    <div className="glass rounded-3xl overflow-hidden card-hover border border-white/5 hover:border-white/12">
                      ...
                      <div className="relative h-56 overflow-hidden">
                        <div className="absolute inset-0"
                          style={{ background: `radial-gradient(ellipse at 40% 30%, ${accent}25 0%, #0f0f0f 55%, #060606 100%)` }} />
                        <div className="absolute inset-0 bg-grid opacity-40" />

                        {/* Stage light effect */}
                        <div className="absolute top-0 left-1/3 w-px h-full"
                          style={{ background: `linear-gradient(180deg, ${accent}40 0%, transparent 100%)`, filter: 'blur(4px)' }} />
                        <div className="absolute top-0 right-1/3 w-px h-full"
                          style={{ background: `linear-gradient(180deg, ${accent}25 0%, transparent 100%)`, filter: 'blur(4px)' }} />
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <h2 className="font-black text-xl text-white group-hover:text-gold transition-colors duration-300">
                              {artist.name}
                            </h2>
