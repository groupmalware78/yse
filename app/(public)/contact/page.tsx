...
const contactInfo = [
  {
    ...
    detail: 'Mon – Sat, 9AM – 7PM EST',
    href: 'tel:+18761234567',
  },
  {
    icon: Mail,
    label: 'Email',
    value: 'info@yardstylement.com',
    detail: 'We reply within 24 hours',
    href: 'mailto:info@yardstylement.com',
  },
  {
    icon: MapPin,
    label: 'Studio Office',
    value: '13 Studio Lane, Kingston 6',
    detail: 'Jamaica, West Indies',
    href: '#map',
  },
  {
    icon: Clock,
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8 pt-32 pb-24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16">
          ...
          <p className="text-white/45 text-lg max-w-lg">
            Have a booking inquiry, press request, or just want to connect? We're here for it.
          </p>
        </motion.div>
            ...
            {submitted ? (
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="btn-gold w-full py-4 rounded-xl text-sm font-bold tracking-widest uppercase inline-flex items-center justify-center gap-2"
                  >
              ...
              >
                {href ? (
                  <a href={href} className="flex items-start gap-4">
                    <div className="w-10 h-10 glass-gold rounded-full flex items-center justify-center flex-shrink-0 border border-gold/20">
          ...
          <div className="glass rounded-3xl overflow-hidden border border-white/5 h-80 relative">
            ...
            <div className="absolute inset-0 opacity-20">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="absolute left-0 right-0 border-t border-gold/10"
                  style={{ top: `${i * 12.5}%` }} />
              ))}
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="absolute top-0 bottom-0 border-l border-gold/10"
                  style={{ left: `${i * 8.33}%` }} />
              ))}
            </div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              ...
              >
                <div className="glass-gold rounded-2xl px-5 py-3 border border-gold/30 text-center mb-2">
                  ...
                  <p className="text-white/45 text-xs">Kingston 6, Jamaica</p>
                </div>
            ...
            <div className="absolute bottom-4 right-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-glass px-4 py-2 rounded-full text-xs font-bold inline-flex items-center gap-2"
              >
