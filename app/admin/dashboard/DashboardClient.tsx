...
interface Props {
  ...
  recentBookings: { id: string; name: string; eventName: string; service: string; budget: string; status: string }[]
  upcomingEvents: { id: number; title: string; date: string; city: string }[]
}

export function DashboardClient({
  greeting, adminName, artistCount, releaseCount, eventCount,
  bookingStats, recentBookings, upcomingEvents,
}: Props) {
  return (
    <div>
      <AdminHeader
